...
function Hero() {
  ...
  return (
    <section className="relative overflow-hidden py-14 sm:py-16 lg:py-20 bg-[#F8F7F4]">
      ...
      <div className="relative z-10">
        <Container>
          <div className="max-w-5xl mx-auto text-center px-2 sm:px-4">
            ...
            <h1 className="mt-8 text-4xl sm:text-5xl lg:text-7xl font-extrabold leading-tight text-slate-900">
              One Platform.
              <br />
            ...
            <p className="mt-6 sm:mt-8 text-base sm:text-lg lg:text-xl text-slate-600 leading-7 sm:leading-8 lg:leading-9 max-w-3xl mx-auto">
            ...
            <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5">
